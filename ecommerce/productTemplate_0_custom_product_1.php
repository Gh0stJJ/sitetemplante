<section class="u-align-center u-clearfix u-section-1" id="sec-cc64">
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
        ...
        <?php $addZeroCents = true ?><div data-add-zero-cents="true" class="u-product-control u-product-price u-product-price-1">
...
?>
        ...
        <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#sec-0f6f" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-product-control u-text-black u-text-hover-white u-btn-1 u-dialog-link u-payment-button" data-product-button-click-type="add-to-cart" data-product-id=""><!--product_button_content-->Agregar al carro<!--/product_button_content--></a>
      </div>
