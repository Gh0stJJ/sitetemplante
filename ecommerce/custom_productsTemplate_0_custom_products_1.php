...
?>
            ...
            <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-align-center u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-2 u-add-to-cart-link" data-product-button-click-type="add-to-cart" data-product-id=""><!--product_button_content-->Agregar al carro<!--/product_button_content--></a>
          </div>
...
?>
            ...
            <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-align-center u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-3 u-add-to-cart-link" data-product-button-click-type="add-to-cart" data-product-id=""><!--product_button_content-->Agregar al carro<!--/product_button_content--></a>
          </div>
...
?>
            ...
            <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-align-center u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-4 u-add-to-cart-link" data-product-button-click-type="add-to-cart" data-product-id=""><!--product_button_content-->Agregar al carro<!--/product_button_content--></a>
          </div>
...
?>
            ...
            <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-align-center u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-5 u-add-to-cart-link" data-product-button-click-type="add-to-cart" data-product-id=""><!--product_button_content-->Agregar al carro<!--/product_button_content--></a>
          </div>
...
?>
            ...
            <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-align-center u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-6 u-add-to-cart-link" data-product-button-click-type="add-to-cart" data-product-id=""><!--product_button_content-->Agregar al carro<!--/product_button_content--></a>
          </div>
